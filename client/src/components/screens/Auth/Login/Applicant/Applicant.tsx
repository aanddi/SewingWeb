    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.applicant__form}>
        ...
        <div className={styles.applicant__enter}>
          ...
          <Link href='/' className={styles.applicant__forgot}>Забыли пароль?</Link>
        </div>
        <Link href='/' className={styles.applicant__registration}>Нет аккаунта?<span>Зарегистрироваться</span></Link>
      </form>
    </AuthLayout>
  )
}
