        ...
        <div className="aboutCompany__container">
          <div className={styles.aboutCompany__wrapper}>
            <div className={styles.aboutCompany__content}>
              ...
              <section
                className={[styles.aboutCompany__info, styles.info].join(' ')}
              >
              ...
              <section
                className={[styles.aboutCompany__desc, styles.desc].join(' ')}
              >
                «Магнит» – не просто один из крупнейших частных работодателей
                России. Мы – семья магазинов, поэтому ценим каждого из 360 тысяч
                сотрудников. И очень гордимся, что люди остаются с нами надолго:
                ежегодно около 5 000 человек отмечают 10-летие работы в
                «Магните», получая «Золотой значок». Всего в компании работает
                21 000 «золотых» сотрудников! «Магнит» — лидер по количеству
                магазинов и географии их расположения. Наша сеть включает в себя
                26 077 торговых объектов в 67 регионах. А значит, вы можете
                работать ближе к дому, семье и детям. А ещё в семью «Магнита»
                входят 13 предприятий по производству продуктов, 4
                агропромышленных комплекса, 45 складских и 37 автотранспортных
                центров. Какой формат притягивает вас больше? Выбирайте работу
                по душе! Станьте частью семьи «Магнит»!
              </section>
              <section
                className={[styles.aboutCompany__reviews, styles.reviews].join(
                  ' '
                )}
              >
              ...
              <section
                className={[
                  styles.aboutCompany__vacancies,
                  styles.vacancies
                ].join(' ')}
              >
