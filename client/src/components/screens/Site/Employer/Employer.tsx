        ...
        <section className={[styles.employer__main, styles.main].join(' ')}>
          <div className="main__container">
            <div className={styles.main__wrapper}>
              <h1 className={styles.main__title}> Разместите <br /> вакансию на SewingWeb</h1>
              <h3 className={styles.main__subTitle}> Все необходимые инструменты для качественного найма </h3>
              <div className={styles.main__buttons}>
                <Link href="/" className={[styles.main__button, styles.main__button_blue].join(' ')}>Разместить вакансию</Link>
                <Link href="/" className={[styles.main__button, styles.main__button_transparent].join(' ')}>Найти резюме</Link>
              </div>
              <p className={styles.main__description}>Вакансия — это объявление о поиске сотрудника. Опишите, кто нужен, и выбирайте лучших среди откликнувшихся.</p>
                ...
                <div className={styles.rates__card}>
                  <div className={styles.rates__content}>
                    ...
                    <div className={styles.rates__efficiency}>
                      ...
                      <p className={[styles.rates__efficiencyDesc, styles.rates__efficiencyDesc_one].join(' ')}>обычная <br /> эффективность</p>
                    </div>
                    <div className={styles.rates__list}>
                      <div className={styles.rates__item}>
                        <div className={styles.rates__icon}><Image src={activeMark} alt={''}/></div>
                      ...
                      <div className={styles.rates__item}>
                        <div className={styles.rates__icon}><Image src={unactiveMark} alt={''}/></div>
                ...
                <div className={styles.rates__card}>
                  <div className={styles.rates__content}>
                    ...
                    <div className={styles.rates__efficiency}>
                      ...
                      <div className={[styles.rates__efficiencyDesc, styles.rates__efficiencyDesc_two].join(' ')}>в 3 раза <br /> эффективность</div>
                    </div>
                    <div className={styles.rates__list}>
                      <div className={styles.rates__item}>
                        <div className={styles.rates__icon}><Image src={activeMark} alt={''}/></div>
                ...
                <div className={styles.rates__card}>
                  <div className={styles.rates__content}>
                    ...
                    <div className={styles.rates__efficiency}>
                      ...
                      <div className={[styles.rates__efficiencyDesc, styles.rates__efficiencyDesc_three].join(' ')}>в 6 раз <br /> эффективность</div>
                    </div>
                    <div className={styles.rates__list}>
                      <div className={styles.rates__item}>
                        <div className={styles.rates__icon}><Image src={activeMark} alt={''}/></div>
                  ...
                  <div className={styles.feedback__title}>Остались вопросы?</div>
                    ...
                    <div className={styles.feedback__left}>
                      ...
                      <p className={styles.feedback__desc}>
                        Техническая поддержка и менеджеры 
                    ...
                    <div className={styles.feedback__right}>
                      ...
                      <p className={styles.feedback__agreement}>
                        Нажимая кнопку  «Отправить», вы принимаете условия <span>Правил</span> и <span>Соглашения</span> об использовании сайта SewingWeb.ru
                      </p>
