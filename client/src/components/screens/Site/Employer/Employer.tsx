  ...
  return (
    <SiteLayout>
      <div className={styles.employer}>
          ...
          <div className="main__container">
            <div className={styles.main__wrapper}>
              ...
              <h3 className={styles.main__subTitle}>
                {' '}
                Все необходимые инструменты для качественного найма{' '}
              </h3>
              <div className={styles.main__buttons}>
                ...
                <Link
                  ...
                  className={[
                    styles.main__button,
                    styles.main__button_transparent
                  ].join(' ')}
                >
                  Найти резюме
                </Link>
              ...
              <p className={styles.main__description}>
                Вакансия — это объявление о поиске сотрудника. Опишите, кто
                нужен, и выбирайте лучших среди откликнувшихся.
              </p>
              <Image
                src={head_line}
                alt=""
                className={[
                  styles.main__pattern,
                  styles.main__pattern_line
                ].join(' ')}
              />
              <Image
                src={head_img1}
          ...
          <div className="info__container">
            <div className={styles.info__wrapper}>
              <Image
                ...
                alt=""
                className={[
                  styles.info__pattern,
                  styles.info__pattern_top
                ].join(' ')}
              />
              <Image
                src={pattern2}
              ...
              <Image
                ...
                className={[
                  styles.info__pattern,
                  styles.info__pattern_leftBottom
                ].join(' ')}
              />
              {/*
              ...
              */}
              <Image
                ...
                className={[
                  styles.info__pattern,
                  styles.info__pattern_rightBottom
                ].join(' ')}
              />
              ...
              <div className={styles.info__cards}>
                <Image
                  src={arrowTop}
                  alt=""
                  className={[styles.info__arrow, styles.info__arrow_top].join(
                    ' '
                  )}
                />
                <Image
                  src={arrowBot}
                  alt=""
                  className={[styles.info__arrow, styles.info__arrow_bot].join(
                    ' '
                  )}
                />
                <div className={styles.info__card}>
                  <div className={styles.info__content}>
                    ...
                    <h3 className={styles.info__cardTitle}>
                      Зарегистрируйтесь
                    </h3>
                    <p className={styles.info__cardSubTitle}>
                      Откройте для себя все удобства нашего сервиса
                    </p>
                  </div>
                </div>
                <div className={styles.info__card}>
                  <div className={styles.info__content}>
                    ...
                    <p className={styles.info__cardSubTitle}>
                      Выберите подходящий для себя тариф
                    </p>
                  </div>
                </div>
                <div className={styles.info__card}>
                  <div className={styles.info__content}>
                    ...
                    <p className={styles.info__cardSubTitle}>
                      Читайте резюме откликнувшихся и выберайте лучших
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.rates__cards}>
                <div className={styles.rates__card}>
                  <div className={styles.rates__content}>
                    <div className={styles.rates__cardTitle}>
                      Вакансия Стандарт
                    </div>
                    <div className={styles.rates__efficiency}>
                      <p
                        className={[
                          styles.rates__efficiencyNumber,
                          styles.rates__efficiencyNumber_one
                        ].join(' ')}
                      >
                        x1
                      </p>
                      <p
                        className={[
                          styles.rates__efficiencyDesc,
                          styles.rates__efficiencyDesc_one
                        ].join(' ')}
                      >
                  ...
                  <div className={styles.rates__content}>
                    ...
                    <div className={styles.rates__efficiency}>
                      <div
                        className={[
                          styles.rates__efficiencyNumber,
                          styles.rates__efficiencyNumber_two
                        ].join(' ')}
                      >
                        x2
                      </div>
                      <div
                        className={[
                          styles.rates__efficiencyDesc,
                          styles.rates__efficiencyDesc_two
                        ].join(' ')}
                      >
                  ...
                  <div className={styles.rates__content}>
                    ...
                    <div className={styles.rates__efficiency}>
                      <div
                        className={[
                          styles.rates__efficiencyNumber,
                          styles.rates__efficiencyNumber_three
                        ].join(' ')}
                      >
                        x6
                      </div>
                      <div
                        className={[
                          styles.rates__efficiencyDesc,
                          styles.rates__efficiencyDesc_three
                        ].join(' ')}
                      >
        ...
        <section
          className={[styles.employer__feedback, styles.feedback].join(' ')}
        >
                ...
                <div className={styles.feedback__content}>
                  ...
                  <div className={styles.feedback__contentWrapper}>
                    <div className={styles.feedback__left}>
                      <h4 className={styles.feedback__write}>
                        Напишите или позвоните
                      </h4>
                      <p className={styles.feedback__desc}>
                        Техническая поддержка и менеджеры ответят на все ваши
                        вопросы:
                      </p>
                      <div className={styles.feedback__contacts}>
                        <p className={styles.feedback__contactsItem}>
                          +79780000000
                        </p>
                        <p className={styles.feedback__contactsItem}>
                          mailto:your@mail.ru
                    ...
                    <div className={styles.feedback__right}>
                      ...
                      <p className={styles.feedback__agreement}>
                        ...
                        <span>Правил</span> и <span>Соглашения</span> об
                        использовании сайта SewingWeb.ru
                      </p>
