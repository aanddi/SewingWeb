              ...
              <div className={styles.about__name}>Швея</div>
                ...
                <div className={styles.about__description}>
                  ...
                  <div className={styles.about__textBlock}>
                    ...
                    <p>
                      Качество пошива;
                      Знание и умение работать на промышленном швейном оборудовании;
                      Внимательность и добросовестность;
                  ...
                  <div className={styles.about__textBlock}>
                    ...
                    <p>
                      Проведение мероприятий по пошиву одежды
                      Отслеживание соответствия качества кроя требуемым параметрам
                      Регулирование натяжение нитей и своевременная замена катушек
                      Применение соответствующих методов пошива для разных типов изделий
                      Подготовка материала к пошиву
                      Чистка изготовленных изделий от мусора
                      Оперативный контроль соответствия цвета материала, его типа и фактуры изготавливаемым изделиям
                      Мониторинг состояния используемого оборудования
                    </p>
                  </div>
                  <div className={styles.about__textBlock}>
                    <div className={styles.about__title}>Условия:</div>
                    <p>
                      Комфортное и просторное швейное производство, расположенное в шаговой доступности от метро (15 мин.п), с новым оборудованием, ремонтом, хорошим светом и промышленными кондиционерами во всех помещениях;
                      Сдельная форма оплаты труда. Выплаты 2 раза в месяц без задержек;
                ...
                <div className={styles.about__map}>
                  ...
                  width="100%" height="325" frameborder="0"></iframe>
                </div>
              </div>
                ...
                <div className={styles.about__control}>
                  ...
                  <div className={styles.about__companyCard}>
                    <div className={styles.about__companyWrapper}>
                      ...
                      <p className={styles.about__contactPerson}><span>Контактное лицо:</span> Мария Иванова</p>
