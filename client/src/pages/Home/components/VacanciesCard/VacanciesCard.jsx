...
const VacanciesCard = (props) => {
     ...
     const isPanelCard = (props) => {
          if (props.panel) {
               return 'vacancies__card_hover';
          } else {
               return false;
          }
     }
     ...
     return ( 
          <div className={style.vacancies__card}>
               <div className={style.content}>
                    {
                         props.panel
                         ? <div className={isPanelCard(props)}>
                              <div className="rensponsive__vacan">Отклики</div>
                              <div className="eddit__vacan">Редактировать</div>
                              <div className="del__vacan">Удалить</div>
                         </div>
